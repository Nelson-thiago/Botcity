...
def main():
    ...
    # Encontrando pop-up pelo título da janela
    ...
    # Encontrando referência da janela principal pelo título
    ...
    # Econtrando novamente a referência da janela principal
